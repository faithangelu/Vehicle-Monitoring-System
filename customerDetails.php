                    ...
                    <div class="col-sm-6 right-side">
                      <div class="dropdown pull-right">
                         <button class="btn bg-primary dropdown-toggle" type="button" id="menu14" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           <i class="fa fa-bars"></i>Customer Settings
                           <span class="caret"></span>
                         </button>
                         <ul class="dropdown-menu bg-grey" aria-labelledby="menu14">
                           <li><a href="#" data-toggle="modal" data-target="#addModal">Customer Reports</a></li>
                ...
                <div class="row breadcrumb-div">
                    <div class="col-sm-6">
                        <ul class="breadcrumb">
							                   ...
							                   <li class="active"><a href="customerDetails">Customer Details</a></li>
						            </ul>
                    </div>
                    <!-- /.col-sm-6 -->
             ...
             <div class="panel">
                 <div class="panel-heading">
                     <div class="panel-title">
                         <h5>Table title - Customer Name</h5>
                     </div>
                 </div>
