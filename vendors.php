                    ...
                    <div class="col-sm-6 right-side">
                      <div class="dropdown pull-right">
                         ...
                         <ul class="dropdown-menu bg-grey" aria-labelledby="menu14">
                           ...
                           <li><a href="#" data-toggle="modal" data-target="#uploadModal">Vendor Reports</a></li>
                ...
                <div class="row breadcrumb-div">
                    <div class="col-sm-6">
                        <ul class="breadcrumb">
							                   ...
							                   <li class="active"><a href="vendors">Vendor Management</a></li>
						            </ul>
                    </div>
                    <!-- /.col-sm-6 -->
                    ...
                    <table id="projectTable" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td><a href="vendordetails?id=">ERP Accounting</a></td>
                              <td class="text-center">On-going</td>
                              <td class="text-right">1234.56</td>
                              <td style="width:8%;" class="">
                                    <div class="btn-group btn-group-justified">
                                      <a href="editVendor?id=<?php echo $row["account_id"]; ?>" class="btn collapse in edit-account" role="button"><i class="fa fa-pencil"> </i></a>
                                      <a href="hideVendor?id=<?php echo $row["account_id"]; ?>" class="btn collapse in hide-account" role="button"><i class="fa fa-trash"> </i></a>
                                    </div>
                                    </td>
                            </tr>
                            <tr>
