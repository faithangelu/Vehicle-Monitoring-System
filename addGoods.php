...
<!-- - - - - - -  Title Bar - - - - - - - -->
            <div class="container-fluid">
                <div class="row page-title-div">
                    <div class="col-sm-6">
                        <h2 class="title">Add Goods Item</h2>
                    </div>
                </div>
                ...
                <div class="row breadcrumb-div">
                    <div class="col-sm-6">
                        <ul class="breadcrumb">
                                 ...
                                 <li><a href="list-goods">List of Goods</a></li>
...
<section class="section">
  <div class="container-fluid">
      <div class="row">
        ...
        <div class="panel">
          ...
          <div class="panel-body p-10">
                    ...
                    <div class="form-group">
                        <label class="col-xs-4 control-label">Item Category</label>
                        <div class="col-xs-8">
                    ...
                    <div class="form-group">
                        <label class="col-xs-4 control-label pt-10">Supplier</label>
      ...
      <div class="col-xs-12 text-center">
          <button type="button" class="btn bg-success btn-wide btn-rounded btn-lg" ><i class="fa fa-check"></i>Save New Item</button>
      </div>
