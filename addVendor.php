...
<section class="section">
  <div class="container-fluid">
      <div class="row">
        ...
        <div class="panel">
          ...
          <div class="panel-body p-10">
                    ...
                    <div class="form-group">
                        <label class="col-xs-4 control-label pt-10">Vendor Type</label>
      ...
      <div class="col-xs-12 text-center">
          <button type="button" class="btn bg-success btn-wide btn-rounded btn-lg" ><i class="fa fa-check"></i>Save New Vendor</button>
      </div>
