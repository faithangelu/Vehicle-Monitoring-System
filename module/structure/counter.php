                ...
                <div class="row">
                      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                          <a class="dashboard-stat bg-success-300" href="#">
                              ...
                              <span class="name">Total Vehicles</span>
                              <span class="bg-icon"><i class="far fa-truck"></i></span>
                          </a>
                          <!-- /.dashboard-stat -->
                      ...
                      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                          <a class="dashboard-stat bg-success-500" href="#">
                              <?php 
                                $sql= "SELECT * from db_vehicles_detail where remarks='Vehicle under repair'";
                                $result=mysqli_query($con,$sql);
                                $num_rows = mysqli_num_rows($result);    
                              ?>
                              <span class="number counter"><?php echo $num_rows; ?></span></span>
                              <span class="name">Vehicles for Repair</span>
                              <span class="bg-icon"><i class="far fa-cog"></i></span>
                          </a>
                          <!-- /.dashboard-stat -->
                      </div>
                      <!-- /.col-lg-3 col-md-3 col-sm-6 col-xs-12 -->
